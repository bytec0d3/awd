...
abstract public class NetworkInterface implements ModuleCommunicationListener {
	...
	public List<Connection> connections; // connected hosts
	 ...
	 * @param anotherInterface The interface to connect to
	 */
	public void connect(Connection con, NetworkInterface anotherInterface) {
	 ...
	 */
	public void disconnect(Connection con, NetworkInterface anotherInterface) {
